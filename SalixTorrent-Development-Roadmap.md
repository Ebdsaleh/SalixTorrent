...
**Roadmap status:** v0.5.1 is released/tagged at `8212ac7cc26e4b781d2e5aa0aa3d5981c27022d0`; post-v0.5.1 Tranches 1 through 5 are published and Tranche 6 component placement uses the full-commit Windows-acceptance workflow
**Current implementation checkpoint:** post-v0.5.1 Tranche 6 explicit designer component-placement resolver is the current implementation/docs boundary over published Tranche 5 at `0b821dd1ec9e7b59ba6838ca8ede2dfdd4e1e323`; publication is valid only after the real-Windows validator, visual smoke and pre-commit gate pass
...
**Post-v0.5.1 Tranche 6 full-commit gate:** component placement 16 / 16, designer/relocation 248 / 248, GUI components 64 / 64, Tkinter 40 / 40 and both complete discovery forms 854 / 854; localization/headless/compileall/Git must remain clean, both designer backends plus blank-app/product smoke must pass, and `pre_commit_check.bat` must pass before the single Tranche-6 commit.
