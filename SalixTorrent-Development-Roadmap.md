...
**Roadmap status:** v0.5.1 is released/tagged at `8212ac7cc26e4b781d2e5aa0aa3d5981c27022d0`; post-v0.5.1 Tranches 1 and 2 are published and Tranche 3 property-inspector/editor surface is real-Windows accepted with the final one-commit documentation fold prepared
**Current implementation checkpoint:** post-v0.5.1 Tranche 3 designer property-inspector/editor surface is real-Windows accepted over published Tranche 2 at `079eaf6e05b678aa2708d83c69bb9cdc37db0433`; publication SHA remains pending until the one-commit fold is created
**Current real Windows regression baseline:** 807 / 807 in both post-v0.5.1 Tranche-3 discovery forms with one expected non-Windows shell-behavior skip; designer property-inspector/editor surface 18 / 18, designer/relocation 206 / 206, GUI components 64 / 64 and Tkinter 36 / 36; localization remains 1,337/current, headless reports 3 updates, Dear PyGui/Tkinter/SalixTorrent visual smoke and pre-commit passed.
...
### A27. Concrete designer property-inspector/editor surface — post-v0.5.1 Tranche 3 prepared
