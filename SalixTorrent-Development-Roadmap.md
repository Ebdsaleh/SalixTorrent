...
**Current implementation checkpoint:** Tranche 17 stable-ID designer hierarchy navigation is published at `dev@f07bc5cc0bda02b81ffefd35b2da3a47e1168c7d`; Tranche 18 backend-neutral hierarchy projection/expansion is Windows-accepted and is the current `dev` implementation boundary
**Current real Windows regression baseline:** 720 / 720 in both accepted Tranche-18 discovery forms with one expected non-Windows shell-behavior skip; hierarchy projection 12 / 12, designer/relocation 127 / 127, GUI components 64 / 64 and Tkinter 28 / 28; localization remains 1,337/current, manual visual smoke and pre-commit passed
