...
**Current implementation checkpoint:** Tranche 18 backend-neutral hierarchy projection/expansion is published at `dev@9bd56a7e4a758529a54bbf45c3cc98bc061fa58c`; Tranche 19 backend-neutral designer property-inspector presentation is Windows-accepted and is the current `dev` implementation boundary
**Current real Windows regression baseline:** 733 / 733 in both accepted Tranche-19 discovery forms with one expected non-Windows shell-behavior skip; property inspector 12 / 12, designer/relocation 139 / 139, GUI components 64 / 64 and Tkinter 29 / 29; localization remains 1,337/current, manual visual smoke and pre-commit passed.
...
**Accepted Tranche 19 baseline:** 733 / 733 in both real-Windows discovery forms with one expected skip; property inspector 12 / 12, designer/relocation 139 / 139, GUI components 64 / 64, Tkinter 29 / 29, localization current, manual visual smoke and pre-commit passed; final implementation/acceptance commit and publication are pending
...
### A21. Naming, public API and package/repository split
