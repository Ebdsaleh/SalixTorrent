...
**Roadmap status:** v0.5.1 is released/tagged at `8212ac7cc26e4b781d2e5aa0aa3d5981c27022d0`; post-v0.5.1 Tranche 1 is published and Tranche 2 is the current real-Windows-accepted surface tranche
**Current implementation checkpoint:** post-v0.5.1 Tranche 2 designer hierarchy-panel surface is real-Windows accepted over published Tranche 1 at `376ae76409bbdc47bda0c06e49ba8e3bed920203`
**Current real Windows regression baseline:** 786 / 786 in both post-v0.5.1 Tranche-2 discovery forms with one expected non-Windows shell-behavior skip; designer hierarchy-panel surface 12 / 12, designer/relocation 187 / 187, GUI components 64 / 64 and Tkinter 34 / 34; localization remains 1,337/current, headless reports 3 updates, Dear PyGui/Tkinter/SalixTorrent visual smoke and pre-commit passed.
