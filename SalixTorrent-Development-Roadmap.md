...
**Roadmap status:** v0.5.1 is released/tagged at `8212ac7cc26e4b781d2e5aa0aa3d5981c27022d0`; post-v0.5.1 Tranches 1 through 8 are published and Tranche 9 selected-component pointer resizing uses the full-commit Windows-acceptance workflow
**Current implementation checkpoint:** post-v0.5.1 Tranche 9 pointer resize handles plus the narrow Tkinter Inspector action-layout repair are the current implementation/docs boundary over published Tranche 8 at `44745b0df1c9e41394ed7ab27674815cfe6d1ea3`; publication is valid only after the real-Windows validator, direct-manipulation visual smoke and pre-commit gate pass
**Current real Windows regression baseline:** 885 / 885 in both accepted post-v0.5.1 Tranche-8 discovery forms with one expected non-Windows shell-behavior skip; preview sizing 13 / 13, designer/relocation 277 / 277, GUI components 64 / 64 and Tkinter 42 / 42; localization remains 1,337/current, Dear PyGui/Tkinter/SalixTorrent visual smoke and pre-commit passed; Tranche 8 is published at `44745b0df1c9e41394ed7ab27674815cfe6d1ea3`.
