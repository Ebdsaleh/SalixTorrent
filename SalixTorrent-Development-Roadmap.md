...
**Roadmap status:** v0.5.1 is released/tagged at `8212ac7cc26e4b781d2e5aa0aa3d5981c27022d0`; post-v0.5.1 Tranches 1 through 4 are published and Tranche 5 component-palette requests use the full-commit Windows-acceptance workflow
**Current implementation checkpoint:** post-v0.5.1 Tranche 5 designer component-palette request surface plus Torrent Details menu-routing fix is the current implementation/docs boundary over published Tranche 4 at `31d0d4207c12ffd226bddd29a2a81d26c92e98dd`; publication is valid only after the real-Windows validator, visual smoke and pre-commit gate pass
**Current real Windows regression baseline:** 821 / 821 in both accepted post-v0.5.1 Tranche-4 discovery forms with one expected non-Windows shell-behavior skip; preview click-selection 12 / 12, designer/relocation 218 / 218, GUI components 64 / 64 and Tkinter 38 / 38; localization remains 1,337/current, headless reports 3 updates, Dear PyGui/Tkinter/SalixTorrent visual smoke and pre-commit passed.
...
**Post-v0.5.1 Tranche 5 full-commit gate:** component palette 14 / 14, structural/menu routing 6 / 6, designer/relocation 232 / 232, GUI components 64 / 64, Tkinter 39 / 39 and both complete discovery forms 837 / 837; localization/headless/compileall/Git must remain clean, both designer backends plus blank-app/product smoke must pass, and `pre_commit_check.bat` must pass before the single Tranche-5 commit.
...
### A29. Component palette and explicit insertion-placement requests — post-v0.5.1 Tranche 5 full-commit gate
...
Preparation passes 14 / 14 palette tests, 6 / 6 structural/menu-routing tests, 232 / 232 designer/relocation tests, 64 / 64 GUI-component tests, 39 / 39 live Tkinter tests under Xvfb and complete discovery at **837 / 837**. Real-Windows validation and manual visual checks remain authoritative before commit. Tranche 5 intentionally stops before resolving a palette request into a concrete insertion; that placement surface is the natural next narrow designer seam.
