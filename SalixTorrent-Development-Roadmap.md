...
**Roadmap status:** v0.5.1 is released/tagged at `8212ac7cc26e4b781d2e5aa0aa3d5981c27022d0`; post-v0.5.1 Tranches 1 through 6 are published and Tranche 7 selected-node structural commands/shortcuts use the full-commit Windows-acceptance workflow
**Current implementation checkpoint:** post-v0.5.1 Tranche 7 selected-node structural commands/shortcuts are the current implementation/docs boundary over published Tranche 6 at `9b61c6f61c8c7eb451a52b12283873d8a96555c0`; publication is valid only after the real-Windows validator, visual smoke and pre-commit gate pass
**Current real Windows regression baseline:** 837 / 837 in both accepted post-v0.5.1 Tranche-5 discovery forms with one expected non-Windows shell-behavior skip; component palette 14 / 14, structural/detail-menu routing 6 / 6, designer/relocation 232 / 232, GUI components 64 / 64 and Tkinter 39 / 39; localization remains 1,337/current, headless reports 3 updates, Dear PyGui/Tkinter/SalixTorrent visual smoke and pre-commit passed.
