...
class TrancheValidationScriptTests(unittest.TestCase):
    ...
    def test_validation_script_captures_required_non_visual_acceptance(self):
        ...
        self.assertIn("tests.presentation.test_designer_preview_selection", self.runner_source)
        self.assertIn("tests.presentation.test_designer_component_palette", self.runner_source)
        self.assertIn("tests.presentation.test_designer_component_placement", self.runner_source)
        self.assertIn("tests.presentation.test_designer_shell_shortcuts", self.runner_source)
        ...
        self.assertIn("tests.presentation.test_designer_inspector_live_preview", self.runner_source)
        ...
        self.assertIn("tests.presentation.test_designer_hierarchy_panel", self.runner_source)
        self.assertIn("tests.presentation.test_designer_inspector", self.runner_source)
        self.assertIn("tests.presentation.test_designer_inspector_panel", self.runner_source)
        self.assertIn("tests.presentation.test_designer_workspace", self.runner_source)
        self.assertIn("tests.presentation.test_designer_shell", self.runner_source)
        self.assertIn("tests.presentation.test_designer_shell_menu", self.runner_source)
        self.assertIn("tests.presentation.test_tkinter_backend", self.runner_source)
        self.assertIn("examples\\ecosystem_designer_shell.py", self.runner_source)
        ...
        self.assertIn("DISCOVERY_TEST_COUNT = 956", self.runner_source)
