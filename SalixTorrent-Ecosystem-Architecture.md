...
### Stable-ID designer selection/focus — Tranche 15 prepared
...
Preparation passes 12 / 12 dedicated selection tests, 91 / 91 combined designer/relocation tests, 64 / 64 GUI-component tests and 25 / 25 Tkinter tests, with **681 / 681** complete discovery in the preparation environment and localization still 1,337/current. Real-Windows validation and visual smoke remain the acceptance authority.
