...
Preparation passes 23 / 23 focused layout/drag tests, 334 / 334 designer+relocation, 64 / 64 GUI components, 46 / 46 Tkinter, 946 / 946 complete display-less discovery and 946 / 946 complete Xvfb discovery. Real-Windows visual acceptance remains required for Dear PyGui drag/drop presentation and independent-sibling geometry before publication.
