...
- Tranche-15 preparation advances the focused designer/relocation gate to 91 tests, Tkinter to 25 tests and complete discovery to **681 tests** while preserving the 64-test GUI-component baseline and 1,337/current localization catalog. Real-Windows acceptance remains required before commit/push.
