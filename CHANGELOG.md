...
- Extended the copied/renamed framework probe and tranche validator for the project-file boundary. Prepared validation passes 12 / 12 project tests, 103 / 103 combined designer/relocation tests, 64 / 64 GUI-component tests, 26 / 26 Tkinter tests and **694 / 694** complete discovery tests in the preparation environment.
