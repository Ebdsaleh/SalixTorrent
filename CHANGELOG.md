...
- Added 16 focused placement tests, copied/renamed framework relocation coverage and one real Tkinter placement-host regression. The full-commit Windows gate expects 16 / 16 placement, 248 / 248 designer+relocation, 64 / 64 GUI components, 40 / 40 Tkinter and both complete discovery forms at 854 / 854, with localization/headless/compile/Git and manual dual-backend/product visual checks clean before commit.
