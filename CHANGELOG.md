...
- Added 14 focused component-palette tests, copied/renamed framework relocation coverage and one real Tkinter palette-host regression. The full-commit Windows gate expects 14 / 14 palette, 6 / 6 structural/menu routing, 232 / 232 designer+relocation, 64 / 64 GUI components, 39 / 39 Tkinter and both complete discovery forms at 837 / 837, with localization/headless/compile/Git and manual dual-backend/product visual checks clean before commit.
- Tranche 5 deliberately stops before resolving palette insertion placement. Drag/drop/reparent/resize, multi-selection/mixed values, callback/service/binding editors, file-dialog/template/paste policy, multi-document/autosave/recovery and final public API/schema naming remain later work.
