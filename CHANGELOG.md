...
- Preparation validation advances complete discovery from 602 to **616 tests**. Display-less canonical Linux discovery passes 616 / 616 with 58 expected GUI/platform skips; real-Windows acceptance remains required before commit/push. Canonical localization remains 1,337 strings and `APP_VERSION` remains `0.5.0`.
