...
- Added 12 focused preview-selection tests, updated copied/renamed framework relocation coverage and added two real Tkinter regressions for native click dispatch/highlighting and rebinding after preview replacement. Preparation passes 12 / 12 preview-selection tests, 218 / 218 combined designer/relocation tests, 64 / 64 GUI-component tests, 38 / 38 live Tkinter tests and complete discovery at 821 / 821. The full-commit Windows gate must pass those same counts plus both 821 / 821 discovery forms, localization/headless/compile/Git checks, Dear PyGui/Tkinter/SalixTorrent visual smoke and `pre_commit_check.bat` before commit.
