...
- Updated copied/renamed framework probes and tranche validation for the navigation boundary. Prepared gates are 12 dedicated navigation tests, 115 combined designer/relocation tests, 64 GUI-component tests, 27 Tkinter tests, and **707** complete-discovery tests.
