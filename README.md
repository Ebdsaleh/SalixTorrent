...
The structural-composition tranche is pushed and Windows-validated at **362 / 362 tests passing**, with one expected non-Windows shell-behavior skip. The Create Torrent form/tooltip tranche is pushed and Windows-validated at **370 / 370**. The runtime-state tranche is pushed and Windows-validated at **374 / 374**. The transfer-dialog tranche is pushed and Windows-validated at **380 / 380**. The explicit Preferences binding tranche adds five further component regressions, bringing its expected real-Windows total to **385**.
