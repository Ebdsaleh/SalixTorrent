...
The structural-composition tranche is pushed and Windows-validated at **362 / 362 tests passing**, with one expected non-Windows shell-behavior skip. The Create Torrent form/tooltip tranche is Windows-validated at **370 / 370** and committed locally for push. The subsequent runtime-state tranche adds four headless component regressions, bringing its expected real-Windows total to **374**.
